function post_samples = Gibbs_sampler_CW(A, Y, b_mat, fj_sq, nu,...
...
for t = 1:T 
    ...
    if mod(t, n_report)==0
        ...
        for i = 1:r
            disp(['Overall Metrop. Acceptance rate: ', num2str(floor(acc_times(i)/t*1e4)/100), '%'])
        end
    end
