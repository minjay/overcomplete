function pred_err_Gau_needlet(name)
% Evaluates prediction errors of Gaussian needlet model
...
save(['sim_pred_err_Gau_needlet_', name, '.mat'], 'MSPE_out_all', 'MSPE_in_all',...
